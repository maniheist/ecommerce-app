        ...
        <div className='row'>
            ...
            <div className='col-3'>
                <div className='wishlist-card position-relative'>
                    ...
                    <h6 className='price'><span style={{"color":"red"}}>$ 999.00</span>&nbsp; <strike>$ 1299.00</strike></h6></div>
            ...
            <div className='col-3'>
                <div className='wishlist-card position-relative'>
                    ...
                    <h6 className='price'><span style={{"color":"red"}}>$ 199.00</span>&nbsp; <strike>$ 399.00</strike></h6></div>
             ...
             <div className='col-3'>
                <div className='wishlist-card position-relative'>
                    ...
                    <div className='wishlist-card-image '>
                    <img src='images/rolex.jpg' style={{"height":"307px"}} className='img-fluid w-200' alt=''/>
                    ...
                    <h6 className='price'><span style={{"color":"red"}}>$ 399.00</span>&nbsp; <strike>$ 699.00</strike></h6></div>
