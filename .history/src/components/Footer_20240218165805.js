        ...
        <div className='container-xxl'>
            <div className="row">
                ...
                <div>
                    ...
                    <a href='tel:+91 9014624248' className='mt-4 d-block mb-2 text-white'>+91 9014624248</a>
                    <a href='mailto:kmsreddy2611@gmail.com' className='mt-4 d-block mb-2 text-white'>kmsreddy2611@gmail.com</a>
                    <div className='social_icons d-flex align-items-center gap-30'>
                    <a className="text-white" href=''>
                    <SiLinkedin className='fs-5' color="yellow"/>
                    </a>
                    <a className="text-white" href=''>
                    <FaSquareInstagram className='fs-7' color='yellow'/>
                    </a>
                    
                    <a className="text-white" href=''>
                    <RiGithubLine className='fs-5' color='yellow'/>

                    </a>
                    <a className="text-white" href=''>
                    <ImYoutube2  className='fs-5' color="yellow"/>
                    </a>
