...
<header className='header-bottom py-3'>
  ...
  <button className="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" bg-transparent border-0>
    Shopping Categories
  </button>
