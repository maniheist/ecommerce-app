...
<header className='header-bottom py-3'>
  ...
  <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><to className="dropdown-item" to="">Action</to></li>
    <li><to className="dropdown-item" to="">Another action</to></li>
    <li><to className="dropdown-item" to="">Something else here</to></li>
  </ul>
</div>
        </div>
