    ...
    <div className='wishlist-icon position-absolute'>
      ...
      <img src='images/catbanner-02.jpg' className='img-fluid' alt='product image' />
        ...
        <div className='product-details'>
            ...
            activeColor="#ffd700"
            />
            <p className='description text-dark'>Um símbolo icônico da beleza brasileira é o Carnaval brasileiro, especialmente o Carnaval do Rio de Janeiro...</p>
    ...
    <div className='wishlist-icon position-absolute'>
      ...
      <img src='images/catbanner-02.jpg' className='img-fluid' alt='product image' />
        ...
        <div className='product-details'>
            ...
            activeColor="#ffd700"
            />
            <p className='description'>Um símbolo icônico da beleza brasileira é o Carnaval brasileiro, especialmente o Carnaval do Rio de Janeiro...</p>
