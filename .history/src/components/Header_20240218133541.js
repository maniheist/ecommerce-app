...
<header className='header-bottom py-3'>
  ...
  <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><to className="dropdown-item text-white" to="">Pants</to></li>
    <li><to className="dropdown-item text-white" to="">Shirts</to></li>
    <li><to className="dropdown-item text-white" to="">Shorts Men Women</to></li>
  </ul>
</div>
        </div>
