...
<header className='header-bottom py-3'>
  ...
  <button className="btn btn-secondary dropdown-toggle bg-transparent border-0 gap-15" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
    <img src="images/menu.svg" alt=""/><span>Shopping Categories</span>
  </button>
