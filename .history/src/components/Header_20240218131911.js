...
<header className='header-bottom py-3'>
  ...
  <button className="btn btn-secondary dropdown-toggle bg-transparent border-0 gap-15 d-flex align-items-center" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
    <img src="images/menu.svg" alt=""/><span className='me-5 d-inline-blocto'>hopping Categories</span>
  </button>
  <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><to className="dropdown-item text-white" to="">Action</to></li>
    <li><to className="dropdown-item text-white" to="">Another action</to></li>
    <li><to className="dropdown-item text-white" to="">Something else here</to></li>
  </ul>
</div>
        </div>
