        ...
        <div className='row'>
            <div className='col-12'>
                <div className='auth-card'>
                    ...
                    <div><input type='text' name='firstName' placeholder='First name'  className='form-control'></input></div>
                        <div><input type='text' name='lastName' placeholder='last name'  className='form-control'></input></div>
