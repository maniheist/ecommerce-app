        ...
        <div className='container-xxl'>
            ...
            activeColor="#ffd700"
                    ...
                    <div className='border-bottom py-3'>
                        ...
                        <div className="d-flex gap-10 align-items-center my-2">
                            <h3 className='product-heading'>Shipping & Returns:</h3><p className='product-data my-4 mt-5'>Free Shipping and returns available on all orders! <br />We ship all US domestic orders within <br /> 5-10 business days! </p>
                        </div>
                        <div className="d-flex gap-10 align-items-center my-2">
