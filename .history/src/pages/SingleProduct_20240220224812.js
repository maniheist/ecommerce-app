            ...
            activeColor="#ffd700"
                    ...
                    <div className='border-bottom py-3'>
                        ...
                        <div className="d-flex gap-10 flex-column my-3">
                            <h3 className='product-heading'>Shipping & Returns:</h3><p className='product-data my-4 mt-4'>Free Shipping and returns available on all orders! <br />We ship all US domestic orders within <br /> <b>5-10 business days! </b></p>
                        </div>
                        <div className="d-flex gap-10 align-items-center my-3">
                            ...
                            <FaHandPointDown className='fs-5 me-2'/>Copy Product Link(Cop On To ClipBoard)
