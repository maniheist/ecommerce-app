                    ...
                    <div className='border-bottom py-3'>
                        ...
                        <div className="d-flex gap-10 flex-column mt-2 mb-3">
                            ...
                            <div className='d-flex flex-wrap gap-15'>
                                <span className='badge border-radius-1 bg-white text-dark border-secondary'>S</span>
                                <span className='badge border-radius-1 bg-white text-dark border-secondary'>M</span>
                                <span className='badge border-radius-1 bg-white text-dark border-secondary'>XL</span>
                                <span className='badge border-radius-1 bg-white text-dark border-secondary'>XXL</span>
                            </div>
                        </div>
                        <div className="d-flex gap-10 flex-column mt-2 mb-3">
