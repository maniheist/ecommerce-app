      ...
      <div container-xxl>
        <div className='row'>
          ...
          <div className='col-12 mt-5'>
            ...
            <div>
              <ul className='ps-0'>
                <li className='mb-3'><IoHomeSharp className='fs-5'/>
                <address>Hno-2323, Near village Gotur,Kadapa,Pulivendula..! </address></li>
                <li className='mb-3'><FaPhoneAlt className='fs-5'/></li>
                <li className='mb-3'><MdEmail className='fs-5'/></li>
                <li className='mb-3'><HiMiniInformationCircle className='fs-5'/></li>
              </ul>
            </div>
            </div>
