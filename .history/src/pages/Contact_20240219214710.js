        ...
        <div className='row'>
          ...
          <div className='col-12 mt-5'>
            ...
            <form>
              ...
              <div>
                <textarea name='' className='form-control w-100' id='' cols="30" rows="10" placeholder='Comment'></textarea>
              </div>
            </form>
            </div>
            <div><h3 className='contact-title mb-4'>Get In Touch With US </h3></div>
