        ...
        <Link to='/cart' className='button'>Continue To Shipping</Link>
            ...
            <div className='border-bottom py-4'>
                <div className='d-flex gap-10 align-items-center'>
                    ...
                    <span className='badge bg-secondary text-white rounded-circle p-3 position-absolute'>1</span>
                    <img style={{'top':'-20px','right':'2px'}} className='img-fluid' src={watch} alt='product'/></div>
                </div>
                <div>
