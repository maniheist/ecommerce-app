        ...
        <div className='row'>
            ...
            <div className='col-3'>
                <div className='wishlist-card position-relative'>
                    ...
                    <div className='wishlist-card-image '>
                    <img src='images/speaker2.jpg' className='img-fluid w-200' alt=''/>
                        
                    </div>
                    <div className='py-3 px-3'><h5 className='title' style={{"height":"20px"}}>Honor T1 7.0 1 GB RAM 8 GB ROM 7 Inch With Wi-Fi+3G Tablet.
</h5>
                    <h6 className='price'><span style={{"color":"red"}}>$ 99.00</span>&nbsp; <strike>$ 199.00</strike></h6></div>
