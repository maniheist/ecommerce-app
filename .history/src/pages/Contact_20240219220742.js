          ...
          <div className='col-12 mt-5'>
            ...
            <div>
              <ul className='ps-0'>
                ...
                <address>Hno-2323, Near village Gotur,Kadapa,Pulivendula..! </address></li>
                <li className='mb-3 d-flex gap-15 align-items-center'><FaPhoneAlt className='fs-5'/></li>
                <li className='mb-3 d-flex gap-15 align-items-center'><MdEmail className='fs-5'/></li>
                <li className='mb-3 d-flex gap-15 align-items-center'><HiMiniInformationCircle className='fs-5'/></li>
              </ul>
            </div>
            </div>
