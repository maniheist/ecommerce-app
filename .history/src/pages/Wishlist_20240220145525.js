        ...
        <div className='row'>
            ...
            <div className='col-3'>
                <div className='wishlist-card position-relative'>
                    ...
                    <div className='wishlist-card-image '>
                    <img src='images/speaker2.jpg' style={{"height":"290px"}} className='img-fluid w-200' alt=''/>
             ...
             <div className='col-3'>
                <div className='wishlist-card position-relative'>
                    ...
                    <div className='wishlist-card-image '>
                    <img src='images/speaker2.jpg' style={{"height":"250px"}} className='img-fluid w-200' alt=''/>
                        
                    </div>
                    <div className='py-3 px-3'><h5 className='title' >Casotime Watches for Men Analog Quartz Mens Watches Chronograph 30M Waterproof Big Face Leather Watch Work Sport Casual Fashion Designer Dress Wrist Watches Elegant Gift for Men 
</h5>
                    <h6 className='price'><span style={{"color":"red"}}>$ 99.00</span>&nbsp; <strike>$ 199.00</strike></h6></div>
