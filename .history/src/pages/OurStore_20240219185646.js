...
<div className='d-flex align-items-center gap-10'>
        ...
        <div className='d-flex gap-10 align-items-center grid'>
         ...
         <img onClick={()=>{setGrid()}} src='images/gr4.svg' alt='grid' className='d-block img-fluid'/>

        <img onClick={()=>{setGrid()}} src='images/gr3.svg' alt='grid' className='d-block img-fluid'/>


          <img onClick={()=>{setGrid()}} src='images/gr2.svg' alt='grid' className='d-block img-fluid'/>
          
          <img onClick={()=>{setGrid()}} src='images/gr.svg' alt='grid' className='d-block img-fluid'/>
